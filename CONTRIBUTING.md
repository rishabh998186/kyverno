...
4. Indicate which release this PR is triaged for (maintainers) by assigning the PR to the appropriate GitHub Milestone. The previous process of using milestone labels (e.g., `milestone 1.16.0`) is deprecated. This step is important, especially for the documentation maintainers, in order to understand when and where the necessary changes should be made.
